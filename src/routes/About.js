          ...
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 ">
            ...
            <div>
              <p className="text-xl lg:text-2xl  leading-relaxed p-4 text-slate-100">
                ...
                Communications, Computer Science, and Account Management. I have
                a personable personality and solid skills in team-building,
                project management, web development, and UI Design. I have over
                three years of experience, a Bachelor of Science degree in Data
                Communications and Computer Science, and several certifications
                available in the next section. Additionally, I desire to learn
                constantly, whether taking online courses, reading blogs,
